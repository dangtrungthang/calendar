...
/* Đây là class cover từ lịch dương sang lịch âm các thuật toán dưới đây được tham khảo ở trang sau
 các chú nên đọc https://www.informatik.uni-leipzig.de/~duc/amlich/calrules.html */

namespace CalendarApplication
{
	class ConvertSolarToLunar
	{
		// ham convert array ngay duong sang am
		...
		/* chuyển đổi giữa ngày tháng và số ngày Julius */
